...
public class DataModel implements Serializable {
    ...
    public DataModel(String state, String district, String market, String commodity, String variety, String arrival_date, String min_price, String max_price, String modal_price) {
        this.state = state;
